...
public class Main extends Application {
	...
	private static Rectangle midRect = new Rectangle(), midFriendRect = new Rectangle();
	...
	private static void inicializateVariables() {
		...
		createAndSetupDorms();
		setupViewsLists();
		midRect = midCalculate(midRect);
		midRect = setupMidRect(midRect);
		
		midFriendRect = midCalculate(midFriendRect);
		midFriendRect = setupMidRect(midFriendRect);
	...
	private static void addElementsOnScreen() {
		...
		root.getChildren().add(midFriendRect);
	}
	...
	private static Rectangle midCalculate(Rectangle rect) {
	...
	private static Rectangle setupMidRect(Rectangle rect) {
		rect.setWidth(20);
		rect.setHeight(20);
		rect.setFill(Color.rgb(0, 104, 209, 1));
		rect.setStroke(Color.rgb(0, 65, 130, 1));
